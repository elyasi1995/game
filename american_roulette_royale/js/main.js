(function() {
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {}
      ...
      , e = function() {
        for (var b, f = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "), "webkitRequestFullScreen webkitCancelFullScreen webkitCurrentFullScreenElement webkitCancelFullScreen webkitfullscreenchange webkitfullscreenerror".split(" "), "mozRequestFullScreen mozCancelFullScreen mozFullScreenElement mozFullScreenEnabled mozfullscreenchange mozfullscreenerror".split(" "), "msRequestFullscreen msExitFullscreen msFullscreenElement msFullscreenEnabled MSFullscreenChange MSFullscreenError".split(" ")], h = 0, d = f.length, c = {}; h < d; h++)
            if ((b = f[h]) && b[1]in a) {
      ...
      , l = {
        request: function(b) {
            ...
            if (/5\.1[.\d]* Safari/.test(navigator.userAgent))
                ...
                b[k](g && Element.ALLOW_KEYBOARD_INPUT)
        },
        exit: function() {
            a[e.exitFullscreen]()
        },
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        if (e < a) {
            ...
            g < d && (b = d - g,
            g += b,
            e += CANVAS_HEIGHT / CANVAS_WIDTH * b);
        b = a / 2 - e / 2;
        var l = d / 2 - g / 2
          , k = CANVAS_WIDTH / g;
        if (l * k < -EDGEBOARD_X || b * k < -EDGEBOARD_Y)
            s_iScaleFactor = Math.min(a / (CANVAS_HEIGHT - 2 * EDGEBOARD_Y), d / (CANVAS_WIDTH - 2 * EDGEBOARD_X)),
        ...
        s_iScaleFactor = 2 * a,
        s_oStage.scaleX = s_oStage.scaleY = 2 * a) : s_bMobile && !1 === isIOS() ? ($("#canvas").css("width", g + "px"),
        $("#canvas").css("height", e + "px")) : (s_oStage.canvas.width = g,
        s_oStage.canvas.height = e,
        s_iScaleFactor = Math.min(g / CANVAS_WIDTH, e / CANVAS_HEIGHT),
        s_oStage.scaleX = s_oStage.scaleY = s_iScaleFactor);
        0 > b ? ($("#canvas").css("top", b + "px"),
        s_iCanvasOffsetHeight = b) : ($("#canvas").css("top", "0px"),
...
function calculateIntersection(a, d) {
    ...
    k = Math.abs(k - h) - (g + b);
    f = Math.abs(f - n) - (e + l);
    return 0 > k && 0 > f ? (k = Math.min(Math.min(a.width, d.width), -k),
...
(function() {
    function a(a) {
        ...
        a = a || window.event;
        a.type in e ? document.body.className = e[a.type] : (document.body.className = this[d] ? "hidden" : "visible",
...
var CANVAS_WIDTH = 1280, CANVAS_HEIGHT = 768, EDGEBOARD_X = 90, EDGEBOARD_Y = 95, FPS = 30, FPS_TIME = 1E3 / FPS, DISABLE_SOUND_MOBILE = !1, STATE_LOADING = 0, STATE_MENU = 1, STATE_HELP = 1, STATE_GAME = 3, STATE_GAME_WAITING_FOR_BET = 0, STATE_GAME_SPINNING = 1, STATE_GAME_SHOW_WINNER = 2, STATE_DISTRIBUTE_FICHES = 3, ON_SHOW_BET_ON_TABLE = 0, ON_SHOW_ENLIGHT = 1, ON_HIDE_ENLIGHT = 2, ON_MOUSE_DOWN = 0, ON_MOUSE_UP = 1, ON_MOUSE_OVER = 2, ON_MOUSE_OUT = 3, ON_DRAG_START = 4, ON_DRAG_END = 5, ON_CONTROLLER_END = 6, ON_CONTROLLER_REMOVE = 7, ON_CONTROLLER_ROLL = 8, COLOR_RED = "red", COLOR_BLACK = "black", COLOR_ZERO = "zero", TOTAL_MONEY, NUM_FICHE_VALUES = 6, NUMBERS_TO_BET = 38, NUM_FICHES = 6, MIN_BET, MAX_BET, WIN_OCCURRENCE, TIME_WAITING_BET, TIME_SHOW_WINNER, TIME_FICHES_MOV = 1500, DOUBLE_ZERO = 37, NUM_MASK_BALL_SPIN_FRAMES = 100, NUM_BALL_SPIN_FRAMES = 200, NUM_HAND_FOR_ADS, WIDTH_CELL_NUMBER, HEIGHT_CELL_NUMBER, ROW_HISTORY = 19, FONT1 = "arialbold", FONT2 = "plantagenet_cherokeeregular", ENABLE_FULLSCREEN, ENABLE_CHECK_ORIENTATION, SHOW_CREDITS;
function CRouletteSettings() {
    ...
    this._initAttachFiches = function() {
        ...
        for (var a = 127, k = 196, f = 1; f < NUMBERS_TO_BET - 1; f++)
            ...
            0 === f % 3 ? (a += WIDTH_CELL_NUMBER + 3,
            k = 196) : k -= HEIGHT_CELL_NUMBER + 3;
        b.bet_0_1 = {
            x: 97,
            y: 195
        };
        ...
        for (var h = 1; 34 > h; h++)
            ...
            0 === h % 3 ? (a += WIDTH_CELL_NUMBER + 3,
            k = 194) : k -= HEIGHT_CELL_NUMBER + 3;
        a = 128;
        k = 157;
        for (h = f = 1; 25 > h; h++)
            b["bet_" + f + "_" + (f + 1)] = {
            ...
            0 === h % 2 ? (a += WIDTH_CELL_NUMBER + 3,
            k = 157,
            f += 2) : (k -= HEIGHT_CELL_NUMBER + 3,
            f++);
        b.bet_0_1_2 = {
            x: 96,
            y: 158
        ...
        k = 232;
        for (h = f = 1; 12 > h; h++)
            b["bet_" + f + "_" + (f + 1) + "_" + (f + 2) + "_" + (f + 3) + "_" + (f + 4) + "_" + (f + 5)] = {
                x: a,
                y: k
            },
            f += 3,
    ...
    this.generateFichesPileByIndex = function(b) {
        ...
        do {
            ...
            b = Math.floor(b);
            for (var c = 0; c < b; c++)
                k.push(this.getFicheIndexByValue(h));
            f--;
            h = a[f];
            b = d
        } while (0 < d && -1 < f);
...
function CFichesController(a) {
    ...
    this.addFicheOnTable = function(b, a, k) {
        ...
        for (var l = 0; l < c.length; l++)
            k.push(this._attachFichesPile(c[l], a, f, h)),
            h -= 5;
        e.push({
            index: a,
            value: b
    ...
    this.clearLastBet = function() {
        ...
        for (var a = b.pop().num, h, k = 0; k < a; k++) {
            ...
            for (var t = 0; t < l.length; t++)
                this._attachFichesPile(l[t], c.index, u, w),
                w -= 5
        }
        return h * a
    }
...
function CMain(a) {
    var d, g = 0, e = 0, b = STATE_LOADING, l, k;
    ...
    this._loadImages = function() {
        ...
        for (a = 0; a < NUM_MASK_BALL_SPIN_FRAMES; a++)
            s_oSpriteLibrary.addSprite("wheel_handle_" + a, "./sprites/mask_ball_spin/wheel_handle_" + a + ".png");
        for (a = 0; a < NUM_MASK_BALL_SPIN_FRAMES; a++)
            s_oSpriteLibrary.addSprite("wheel_numbers_" + a, "./sprites/wheel_anim/wheel_numbers_" + a + ".png");
...
var s_bMobile, s_bAudioActive = !0, s_bFullscreen = !1, s_iCntTime = 0, s_iTimeElaps = 0, s_iPrevTime = 0, s_iCntFps = 0, s_iCurFps = 0, s_oDrawLayer, s_oStage, s_oMain = null, s_oSpriteLibrary, s_aSounds;
...
function CGfxButton(a, d, g, e) {
    ...
    this.unload = function() {
        ...
        !1 === s_bMobile && (c.off("rollover", this.mouseOver),
        c.off("rollout", this.mouseOut));
        q.removeChild(c)
    }
    ;
    this.setVisible = function(a) {
    ...
    this._initListener = function() {
        ...
        !1 === s_bMobile && (c.on("rollover", this.mouseOver),
        c.on("rollout", this.mouseOut))
    }
    ;
    this.addEventListener = function(a, b, c) {
        f[a] = b;
...
function CMenu() {
    var a, d, g, e, b, l, k, f, h, n, c = null, q = null, w, u, t, p, m, r;
    this._init = function() {
        ...
        d = l + x.width / 2 + 10,
        g = x.height / 2 + 10) : (d = v.width / 4 + 10,
        g = v.height / 2 + 10);
        v = window.document;
        ...
        c && screenfull.enabled && (n = new CToggle(d,g,x,s_bFullscreen,s_oStage),
...
var s_oMenu = null;
function CGame(a) {
    var d = !1, g, e, b, l, k, f, h, n, c, q, w, u, t, p, m, r, v, x, A, C, z, D;
    this._init = function() {
    ...
    this._resetTable = function() {
        ...
        n = [];
        c = [];
        null !== m && (v.getContainer().removeChild(m),
        m = null);
        p.reset();
        z.reset();
        .1 > p.getCredit() ? (e = -1,
        r.hideBlock(),
        D.show()) : (r.enableRebet(),
        this._setState(STATE_GAME_WAITING_FOR_BET));
        f++;
        f === NUM_HAND_FOR_ADS && (f = 0,
    ...
    this._generateWinLoss = function() {
        ...
        if (B < d) {
            ...
            -1 === WIN_OCCURRENCE ? (c = NUMBERS_TO_BET - b,
            e = Math.floor(38 * Math.random())) : (c = WIN_OCCURRENCE,
    ...
    this._rouletteAnimEnded = function() {
        ...
        0 === k ? (m.x = v.getEnlightX(k) + 26,
        m.y = v.getEnlightY(k) + 34) : 37 === k ? (m.x = v.getEnlightX(k) + 26,
        m.y = v.getEnlightY(k) + 34) : (m.x = v.getEnlightX(k) + 8,
        m.y = v.getEnlightY(k) + 16);
        m.regX = 6;
        m.regY = 20;
    ...
    this.onSpin = function() {
        if (z.isVisible())
            z.onExit();
        0 !== p.getCurBet() && (p.getCurBet() < MIN_BET ? (x.show(TEXT_ERROR_MIN_BET),
        r.enableBetFiches(),
        r.enableSpin(!0)) : r.isBlockVisible() || (r.showBlock(),
        z.hide(),
        C.hide(),
        r.enableSpin(!1),
    ...
    this._onShowBetOnTable = function(a, d) {
        ...
        c.push(g);
        var m = p.getCurBet();
        if (0 > p.getCredit() - l * g)
            x.show(TEXT_ERROR_NO_MONEY_MSG),
            z.reset();
        else if (m + l * g > MAX_BET)
            x.show(TEXT_ERROR_MAX_BET_REACHED),
            z.reset();
        else {
            switch (e) {
            case "oBetFinalsBet":
    ...
    this._onShowBetOnTableFromNeighbors = function(a, d) {
        ...
        g * v > p.getCredit() ? (x.show(TEXT_ERROR_NO_MONEY_MSG),
        z.reset()) : (p.createPileForMultipleNumbers(g, a.value, e, f, v),
        r.setMoney(p.getCredit()),
        r.setCurBet(p.getCurBet()),
        r.enableSpin(!0),
        playSound("chip", 1, !1))
    ...
    this.onRebet = function() {
        for (var a = 0; a < u.length; a++)
            !0 === u[a].neighbors ? z.rebet(u[a].num_clicked) : this._onShowBetOnTable(u[a], !0)
    }
    ;
    ...
    this._updateWaitingBet = function() {
        z.isVisible() || 0 === TIME_WAITING_BET || (l += s_iTimeElaps,
        l > TIME_WAITING_BET && (l = 0,
        this.onSpin()))
    }
    ;
    ...
    this._updateDistributeFiches = function() {
        ...
        if (l > TIME_FICHES_MOV)
            ...
            for (var a = s_oTweenController.easeInOutCubic(l, 0, 1, TIME_FICHES_MOV), b = 0; b < w.length; b++)
                w[b].updatePos(a)
    }
    ;
...
function CInterface() {
    var a, d, g, e, b, l, k, f, h, n, c, q = null, w = null, u, t, p, m, r, v, x, A, C, z, D, B;
    this._init = function() {
        ...
        q && screenfull.enabled && (y = s_oSpriteLibrary.getSprite("but_fullscreen"),
        g = y.width / 4 + 10,
        e = y.height / 2 + 10,
    ...
    this.enableBetFiches = function() {
        for (var a = 0; a < NUM_FICHE_VALUES; a++)
            f[a].enable();
        v.enable();
        x.enable();
        A.enable();
    ...
    this._onFicheSelected = function(a) {
        ...
        a = a[0];
        for (var b = 0; b < NUM_FICHE_VALUES; b++)
            b === a && (k = b)
    }
    ;
...
function CTableController() {
    ...
    this._init = function() {
        ...
        !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
        a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this));
        for (var l = s_oSpriteLibrary.getSprite("hit_area_number"), k = 128, f = 194, h = 1; h < NUMBERS_TO_BET; h++)
            a = new CBetTableButton(k,f,l,"bet_" + h,d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
            0 === h % 3 ? (k += WIDTH_CELL_NUMBER + 3,
            f = 194) : f -= HEIGHT_CELL_NUMBER + 3;
        ...
        f = 194;
        for (var n = 1; 34 > n; n++)
            a = new CBetTableButton(k,f,s_oSpriteLibrary.getSprite("hit_area_couple_vertical"),"bet_" + n + "_" + (n + 3),d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
            0 === n % 3 ? (k += WIDTH_CELL_NUMBER + 3,
            f = 194) : f -= HEIGHT_CELL_NUMBER + 3;
        k = 128;
        f = 157;
        for (n = h = 1; 25 > n; n++)
            a = new CBetTableButton(k,f,s_oSpriteLibrary.getSprite("hit_area_couple_horizontal"),"bet_" + h + "_" + (h + 1),d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
            0 === n % 2 ? (k += WIDTH_CELL_NUMBER + 3,
            f = 157,
            h += 2) : (f -= HEIGHT_CELL_NUMBER + 3,
            h++);
        ...
        for (n = 1; 13 > n; n++)
            a = new CBetTableButton(k,f,l,"bet_" + h + "_" + (h + 1) + "_" + (h + 2),d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
        ...
        f = k = 158;
        for (n = h = 1; 23 > n; n++)
            a = new CBetTableButton(k,f,s_oSpriteLibrary.getSprite("hit_area_small"),"bet_" + h + "_" + (h + 1) + "_" + (h + 3) + "_" + (h + 4),d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
            0 === n % 2 ? (k += WIDTH_CELL_NUMBER + 3,
        ...
        for (n = 1; 12 > n; n++)
            a = new CBetTableButton(k,f,l,"bet_" + h + "_" + (h + 1) + "_" + (h + 2) + "_" + (h + 3) + "_" + (h + 4) + "_" + (h + 5),d,!1),
            a.addEventListener(ON_MOUSE_DOWN, this._onBetPress, this),
            !1 === s_bMobile && (a.addEventListener(ON_MOUSE_OVER, this._onBetNumberOver, this),
            a.addEventListener(ON_MOUSE_OUT, this._onBetNumberOut, this)),
            h += 3,
    ...
    this._initEnlights = function() {
        ...
        a.oEnlight_37 = b;
        for (var e = 98, g = 159, f = s_oSpriteLibrary.getSprite("enlight_number"), h = 0; 36 > h; h++)
    ...
    this._onBetNumberOver = function(a) {
        null !== a.numbers && g[ON_SHOW_ENLIGHT] && g[ON_SHOW_ENLIGHT].call(e[ON_SHOW_ENLIGHT], a)
    }
    ;
...
function CWheelAnim(a, d) {
    ...
    this.setShowNumberInfo = function(a) {
        a === DOUBLE_ZERO && (a = "00");
        t.text = a;
        0 < b ? (p.font = "18px " + FONT1,
        p.text = TEXT_YOU_WIN + " " + b + TEXT_CURRENCY) : (p.font = "22px " + FONT1,
        p.text = TEXT_YOU_LOSE);
    ...
    this._ballSpin = function() {
        ...
        q.y = c[f].y;
        f++;
        f === NUM_BALL_SPIN_FRAMES ? (g = !1,
        f = NUM_BALL_SPIN_FRAMES - 1,
        s_oGame._rouletteAnimEnded(),
        this.hide()) : f === NUM_BALL_SPIN_FRAMES / 2 && this._showNumberExtracted()
    }
    ;
    ...
    this.update = function() {
        ...
        2 === k && (k = 0,
        e && (this._ballSpin(),
        l === NUM_MASK_BALL_SPIN_FRAMES - 1 ? this.playToFrame(0) : this.nextFrame())))
    }
    ;
    this._init(a, d)
}
function CFinalBetPanel(a, d) {
    var g, e;
    this._init = function(a, d) {
        g = [[0, 10, 20, 30], [1, 11, 21, 31], [2, 12, 22, 32], [3, 13, 23, 33], [4, 14, 24, 34], [5, 15, 25, 35], [6, 16, 26, 36], [7, 17, 27], [8, 18, 28], [9, 19, 29]];
        e = new createjs.Container;
        e.x = a;
        e.y = d;
        s_oStage.addChild(e);
...
function CNeighborsPanel() {
    ...
    this._init = function() {
        ...
        a.rotate(56);
        f.oEnlight_8 = a;
        a = new CEnlight(316,548,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(-162);
        f.oEnlight_9 = a;
        ...
        a.rotate(-20);
        f.oEnlight_13 = a;
        a = new CEnlight(481,535,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(160);
        f.oEnlight_14 = a;
        ...
        a.rotate(85);
        f.oEnlight_18 = a;
        a = new CEnlight(601,179,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(66);
        f.oEnlight_19 = a;
        ...
        a.rotate(140);
        f.oEnlight_23 = a;
        a = new CEnlight(204,114,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(-38);
        f.oEnlight_24 = a;
        ...
        a.rotate(-171);
        f.oEnlight_28 = a;
        a = new CEnlight(515,88,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(36);
        f.oEnlight_29 = a;
        ...
        a.rotate(112);
        f.oEnlight_33 = a;
        a = new CEnlight(136,219,s_oSpriteLibrary.getSprite("neighbor_enlight"),m);
        a.rotate(-67);
        f.oEnlight_34 = a;
    ...
    this._initNeighbors = function() {
        b = [[14, 2, 0, 28, 9], [36, 13, 1, 37, 27], [35, 14, 2, 0, 28], [34, 15, 3, 24, 36], [33, 16, 4, 23, 35], [32, 17, 5, 22, 34], [31, 18, 6, 21, 33], [30, 11, 7, 20, 32], [29, 12, 8, 19, 31], [0, 28, 9, 26, 30], [37, 27, 10, 25, 29], [26, 30, 11, 7, 20], [25, 29, 12, 8, 19], [24, 36, 13, 1, 37], [23, 35, 14, 2, 0], [22, 34, 15, 3, 24], [21, 33, 16, 4, 23], [20, 32, 17, 5, 22], [19, 31, 18, 6, 21], [12, 8, 19, 31, 18], [11, 7, 20, 32, 17], [18, 6, 21, 33, 16], [17, 5, 22, 34, 15], [16, 4, 23, 35, 14], [15, 3, 24, 36, 13], [27, 10, 25, 29, 12], [28, 9, 26, 30, 11], [1, 37, 27, 10, 25], [2, 0, 28, 9, 26], [10, 25, 29, 12, 8], [9, 26, 30, 11, 7], [8, 19, 31, 18, 6], [7, 20, 32, 17, 5], [6, 21, 33, 16, 4], [5, 22, 34, 15, 3], [4, 23, 35, 14, 2], [3, 24, 36, 13, 1], [13, 1, 37, 27, 10]];
        q = [];
    ...
    this.clearLastBet = function() {
        if (0 !== c.length) {
            ...
            b = h[a];
            0 < b.length ? u.removeChild(b[b.length - 1].getSprite()) : (c = [],
            l[a] = 0);
            k.pop();
            h[a].pop();
            if (0 === c.length)
    ...
    this.addFicheOnNeighborTable = function() {
        ...
        if (e + 5 * f > g)
            ...
            for (var m = q["oAttach_" + a].y, p = 0; p < f.length; p++)
                this._attachFichesPile(f[p], a, k, m),
                m -= 5;
            n.push(a);
    ...
    this._onNeighborOver = function(a) {
        ...
        for (var c = 0; c < a.length; c++)
            f["oEnlight_" + a[c]].show()
    }
    ;
    this._onNeighborOut = function(a) {
        a = b[a.index];
        for (var c = 0; c < a.length; c++)
            f["oEnlight_" + a[c]].hide()
    }
    ;
    this.isVisible = function() {
        return r.visible
...
function CGameOver() {
    ...
    this._init = function() {
        ...
        d.y = 400;
        b.addChild(d);
        g = new CTextButton(CANVAS_WIDTH / 2 + 170,510,s_oSpriteLibrary.getSprite("but_bg"),TEXT_RECHARGE,FONT1,"#fff",14,!1);
...
function CRollingTextController(a, d, g, e, b, l, k) {
    var f, h, n, c, q, w, u, t, p, m, r, v = [], x, A;
    ...
    this.update = function() {
        ...
        if (f > h)
            ...
            clearInterval(u),
            null !== m[ON_CONTROLLER_END] && void 0 !== m[ON_CONTROLLER_END] && m[ON_CONTROLLER_END].call(r[ON_CONTROLLER_END], this),
            0 < w ? this.setUpdateInfo(w) : null !== m[ON_CONTROLLER_REMOVE] && void 0 !== m[ON_CONTROLLER_REMOVE] && m[ON_CONTROLLER_REMOVE].call(r[ON_CONTROLLER_REMOVE], this);
        else {
            switch (t) {
            case EASE_BACKIN:
            ...
            for (var b = 0; b < v.length; b++)
                a > v[b].step && !v[b].flag && (v[b].flag = !0,
                null !== m[ON_CONTROLLER_ROLL] && m[ON_CONTROLLER_ROLL].call(r[ON_CONTROLLER_ROLL], b));
